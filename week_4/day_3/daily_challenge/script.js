...
// carInventory‘s value is an array 
...
const getCarHonda = (inv) => inv[inv.findIndex((value) => value.car_make === "Honda")];
...
//Notice: ive changed the original array in-place 
//and didnt create another sorted array 
